...
class Test_3b(GradedTestCase):
  ...
  def test_2(self):
    ...
    self.assertAlmostEqual(solution_accuracies[0], student_accuracies[0])
    print("Comparing Accuracy of Negative Examples")
    self.assertAlmostEqual(solution_accuracies[1], student_accuracies[1])
    print("Comparing Balanced Accuracy")
    self.assertAlmostEqual(solution_accuracies[2], student_accuracies[2])
    print("Comparing Total Accuracy")
    self.assertAlmostEqual(solution_accuracies[3], student_accuracies[3])

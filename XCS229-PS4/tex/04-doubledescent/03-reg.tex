...
\begin{figure}[H]
    ...
    \caption{Num of samples vs. validation error for different regularization strengths. Visual impaired students can access the corresponding desmos plot \href{https://www.desmos.com/calculator/bkwavglgnk}{here}}
    \centering
\end{figure}
